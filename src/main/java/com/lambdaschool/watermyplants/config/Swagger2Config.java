...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("Watermyplants Model")
            .description("Watermyplants Model")
            .contact(new Contact("Jamie & Fidan",
                "http://www.lambdaschool.com","fidan-novruzova@lambdastudents.com"))
            .license("MIT")
